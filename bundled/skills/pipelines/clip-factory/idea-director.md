...
description: "Produce brief for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "idea"
produces: "brief"
---
# Idea Director - Clip Factory

## Goal

Produce a schema-valid `brief.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

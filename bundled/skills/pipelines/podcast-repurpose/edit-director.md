...
description: "Produce edit_decisions for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Podcast Repurpose

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

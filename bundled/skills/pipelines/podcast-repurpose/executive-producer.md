...
description: "Orchestrate the Podcast Repurpose bundled pipeline."
applies_to: "pipelines/podcast-repurpose"
---
# Executive Producer - Podcast Repurpose

This is the demo readiness lane: podcast-repurpose. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

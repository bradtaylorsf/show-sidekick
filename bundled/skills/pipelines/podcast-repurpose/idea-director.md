...
description: "Produce brief for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "idea"
produces: "brief"
---
# Idea Director - Podcast Repurpose

## Goal

Produce a schema-valid `brief.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

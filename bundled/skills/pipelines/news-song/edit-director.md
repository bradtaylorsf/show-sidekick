...
description: "Produce edit_decisions for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - News Song

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

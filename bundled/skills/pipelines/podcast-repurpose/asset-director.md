---
name: "podcast-repurpose-assets-director"
description: "Produce asset_manifest for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Podcast Repurpose

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

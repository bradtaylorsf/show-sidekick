...
description: "Produce brief for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "idea"
produces: "brief"
---
# Idea Director - News Song

## Goal

Produce a schema-valid `brief.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

...
description: "Produce publish_log for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Podcast Repurpose

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

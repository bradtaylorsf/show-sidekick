---
name: "animation-idea-director"
description: "Produce brief for the Animation pipeline."
applies_to: "pipelines/animation"
stage: "idea"
produces: "brief"
---
# Idea Director - Animation

## Goal

Produce a schema-valid `brief.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

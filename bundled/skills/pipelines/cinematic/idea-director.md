---
name: "cinematic-idea-director"
description: "Produce brief for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "idea"
produces: "brief"
---
# Idea Director - Cinematic

## Goal

Produce a schema-valid `brief.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

---
name: "screen-demo-assets-director"
description: "Produce asset_manifest for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Screen Demo

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

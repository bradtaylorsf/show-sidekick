...
description: "Produce render_report for the Animation pipeline."
applies_to: "pipelines/animation"
stage: "compose"
produces: "render_report"
---
# Compose Director - Animation

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

...
description: "Produce brief for the Avatar Spokesperson pipeline."
applies_to: "pipelines/avatar-spokesperson"
stage: "idea"
produces: "brief"
---
# Idea Director - Avatar Spokesperson

## Goal

Produce a schema-valid `brief.json` artifact that fits the `avatar-spokesperson` pipeline and can be reviewed without private harness context.

...
description: "Orchestrate the Cinematic bundled pipeline."
applies_to: "pipelines/cinematic"
---
# Executive Producer - Cinematic

This is the demo readiness lane: cinematic. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

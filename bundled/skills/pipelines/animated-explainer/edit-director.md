...
description: "Produce edit_decisions for the Animated Explainer pipeline."
applies_to: "pipelines/animated-explainer"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Animated Explainer

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

...
The sample episode is pre-filled for `showkick init --starter news-song` and uses project-relative input paths under `shows/news-song/inputs/sample-episode/`.

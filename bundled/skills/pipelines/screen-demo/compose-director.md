...
description: "Produce render_report for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "compose"
produces: "render_report"
---
# Compose Director - Screen Demo

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

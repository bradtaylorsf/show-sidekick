...
description: "Produce brief for the Talking Head pipeline."
applies_to: "pipelines/talking-head"
stage: "idea"
produces: "brief"
---
# Idea Director - Talking Head

## Goal

Produce a schema-valid `brief.json` artifact that fits the `talking-head` pipeline and can be reviewed without private harness context.

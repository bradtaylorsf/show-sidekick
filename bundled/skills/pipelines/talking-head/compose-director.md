...
description: "Produce render_report for the Talking Head pipeline."
applies_to: "pipelines/talking-head"
stage: "compose"
produces: "render_report"
---
# Compose Director - Talking Head

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `talking-head` pipeline and can be reviewed without private harness context.

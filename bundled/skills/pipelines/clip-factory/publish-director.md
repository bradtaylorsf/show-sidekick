...
description: "Produce publish_log for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Clip Factory

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

...
description: "Produce publish_log for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Cinematic

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

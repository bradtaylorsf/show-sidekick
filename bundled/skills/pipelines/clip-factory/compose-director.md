...
description: "Produce render_report for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "compose"
produces: "render_report"
---
# Compose Director - Clip Factory

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

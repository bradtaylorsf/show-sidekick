---
name: "cinematic-scene-plan-director"
description: "Produce scene_plan for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Cinematic

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

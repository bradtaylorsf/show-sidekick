...
- [manim-composer/references/narrative-manim-composer/patterns.md](manim-composer/references/narrative-manim-composer/patterns.md) - Common 3b1b narrative structures
- [manim-composer/references/visual-techniques.md](manim-composer/references/visual-techniques.md) - Effective visualization patterns
- [manim-composer/references/scene-examples.md](manim-composer/references/scene-examples.md) - Example scenes.md excerpts

## Templates

- [manim-composer/templates/scenes-template.md](manim-composer/templates/scenes-template.md) - Blank scenes.md template

...
|-------|----------|---------|
| Prior artifacts | `priorArtifacts.compose`, `priorArtifacts.script`, `priorArtifacts.idea` | Rendered outputs, approved script package, and localization scope |
| Playbook | Active style playbook | Metadata and title consistency |

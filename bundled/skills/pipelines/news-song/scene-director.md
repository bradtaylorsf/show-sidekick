---
name: "news-song-scene-plan-director"
description: "Produce scene_plan for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - News Song

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

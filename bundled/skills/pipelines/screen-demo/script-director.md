---
name: "screen-demo-script-director"
description: "Produce script for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "script"
produces: "script"
---
# Script Director - Screen Demo

## Goal

Produce a schema-valid `script.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

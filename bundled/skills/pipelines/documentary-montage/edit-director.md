...
description: "Produce edit_decisions for the Documentary Montage pipeline."
applies_to: "pipelines/documentary-montage"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Documentary Montage

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `documentary-montage` pipeline and can be reviewed without private harness context.

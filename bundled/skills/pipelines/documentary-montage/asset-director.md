---
name: "documentary-montage-assets-director"
description: "Produce asset_manifest for the Documentary Montage pipeline."
applies_to: "pipelines/documentary-montage"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Documentary Montage

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `documentary-montage` pipeline and can be reviewed without private harness context.

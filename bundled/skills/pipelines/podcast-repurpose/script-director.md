---
name: "podcast-repurpose-script-director"
description: "Produce script for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "script"
produces: "script"
---
# Script Director - Podcast Repurpose

## Goal

Produce a schema-valid `script.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

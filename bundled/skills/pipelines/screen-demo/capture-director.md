...
description: "Produce capture_manifest for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "capture"
produces: "capture_manifest"
---
# Capture Director - Screen Demo

## Goal

Produce a schema-valid `capture_manifest.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.
...
- The artifact matches `schemas/artifacts/capture_manifest.schema.json`.

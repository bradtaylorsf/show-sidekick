...
description: "Produce edit_decisions for the Animation pipeline."
applies_to: "pipelines/animation"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Animation

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

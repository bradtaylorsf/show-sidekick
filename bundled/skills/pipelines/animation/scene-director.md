---
name: "animation-scene-plan-director"
description: "Produce scene_plan for the Animation pipeline."
applies_to: "pipelines/animation"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Animation

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

...
description: "Produce character_design for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "character_design"
produces: "character_design"
---
# Character Design Director - Character Animation

## Goal

Produce a schema-valid `character_design.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.
...
- The artifact matches `schemas/artifacts/character_design.schema.json`.

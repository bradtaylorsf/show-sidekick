---
name: "character-animation-script-director"
description: "Produce script for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "script"
produces: "script"
---
# Script Director - Character Animation

## Goal

Produce a schema-valid `script.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.

---
name: "news-song-assets-director"
description: "Produce asset_manifest for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - News Song

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

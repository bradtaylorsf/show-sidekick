...
description: "Layer 3 agent skill for synthetic-screen-recording."
applies_to: "agents"
agent_skill: true
critical: false
epic: 8
...
Located at: `src/remotion/src/components/TerminalScene.tsx`
Exported from: `src/remotion/src/components/index.ts`
Wired in dispatch: `src/remotion/src/Explainer.tsx` (`if (cut.type === "terminal_scene")`)
...
Wired in dispatch at: `src/remotion/src/Explainer.tsx` overlay renderer (`overlay.type === "provider_chip"`).
...
7. Update `src/remotion/SCENE_TYPES.md` with the new cut type.

...
description: "Produce edit_decisions for the Talking Head pipeline."
applies_to: "pipelines/talking-head"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Talking Head

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `talking-head` pipeline and can be reviewed without private harness context.

...
description: "Produce proposal_packet for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "proposal"
produces: "proposal_packet"
---
# Proposal Director - Character Animation

## Goal

Produce a schema-valid `proposal_packet.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.
...
- The artifact matches `schemas/artifacts/proposal_packet.schema.json`.

---
name: "documentary-montage-publish-director"
description: "Produce publish_log for the Documentary Montage pipeline."
applies_to: "pipelines/documentary-montage"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Documentary Montage

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `documentary-montage` pipeline and can be reviewed without private harness context.

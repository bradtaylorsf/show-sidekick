---
name: "clip-factory-scene-plan-director"
description: "Produce scene_plan for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Clip Factory

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

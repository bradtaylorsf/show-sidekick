...
description: "Produce render_report for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "compose"
produces: "render_report"
---
# Compose Director - Podcast Repurpose

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

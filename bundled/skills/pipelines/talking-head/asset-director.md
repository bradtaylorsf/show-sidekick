---
name: "talking-head-assets-director"
description: "Produce asset_manifest for the Talking Head pipeline."
applies_to: "pipelines/talking-head"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Talking Head

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `talking-head` pipeline and can be reviewed without private harness context.

...
description: "Produce edit_decisions for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Cinematic

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

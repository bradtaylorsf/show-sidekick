...
> **Setup:** See [Installation Guide](agents/references/installation.md) for CLI and SDK setup.
...
See [Agent Configuration](agents/references/agent-configuration.md) for all options.
...
See [Client Tools Reference](agents/references/client-tools.md) for complete documentation.
...
See [Widget Embedding Reference](agents/references/widget-embedding.md) for all options.
...
See [Outbound Calls Reference](agents/references/outbound-calls.md) for configuration overrides and dynamic variables.
...
See [Agent Configuration](agents/references/agent-configuration.md) for all configuration options and SDK examples.
...
- [Installation Guide](agents/references/installation.md) - SDK setup and migration
- [Agent Configuration](agents/references/agent-configuration.md) - All config options and CRUD examples
- [Client Tools](agents/references/client-tools.md) - Webhook, client, and system tools
- [Widget Embedding](agents/references/widget-embedding.md) - Website integration
- [Outbound Calls](agents/references/outbound-calls.md) - Twilio phone call integration

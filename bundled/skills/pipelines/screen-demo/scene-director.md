---
name: "screen-demo-scene-plan-director"
description: "Produce scene_plan for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Screen Demo

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

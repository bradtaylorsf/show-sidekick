...
description: "Orchestrate the Character Animation bundled pipeline."
applies_to: "pipelines/character-animation"
---
# Executive Producer - Character Animation

This is the demo readiness lane: character-animation. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

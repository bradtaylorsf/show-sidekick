---
name: "avatar-spokesperson-scene-plan-director"
description: "Produce scene_plan for the Avatar Spokesperson pipeline."
applies_to: "pipelines/avatar-spokesperson"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Avatar Spokesperson

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `avatar-spokesperson` pipeline and can be reviewed without private harness context.

...
Run `showkick doctor --profile paid-demo` before a paid sample. To record the selected lane for an episode, run `showkick build <show>/<episode> --sample --provider-profile paid-demo`.

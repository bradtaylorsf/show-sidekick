...
description: "Produce publish_log for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Character Animation

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.

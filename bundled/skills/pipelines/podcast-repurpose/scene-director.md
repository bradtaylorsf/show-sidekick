---
name: "podcast-repurpose-scene-plan-director"
description: "Produce scene_plan for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Podcast Repurpose

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.

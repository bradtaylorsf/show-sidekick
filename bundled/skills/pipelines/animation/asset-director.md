---
name: "animation-assets-director"
description: "Produce asset_manifest for the Animation pipeline."
applies_to: "pipelines/animation"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Animation

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

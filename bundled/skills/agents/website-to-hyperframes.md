...
**Read:** [website-to-hyperframes/references/step-1-capture.md](website-to-hyperframes/references/step-1-capture.md)
...
**Read:** [website-to-hyperframes/references/step-2-design.md](website-to-hyperframes/references/step-2-design.md)
...
**Read:** [website-to-hyperframes/references/step-3-script.md](website-to-hyperframes/references/step-3-script.md)
...
**Read:** [website-to-hyperframes/references/step-4-storyboard.md](website-to-hyperframes/references/step-4-storyboard.md)
...
**Read:** [website-to-hyperframes/references/step-5-vo.md](website-to-hyperframes/references/step-5-vo.md)
...
**Read:** [website-to-hyperframes/references/step-6-build.md](website-to-hyperframes/references/step-6-build.md)
...
**Read:** [website-to-hyperframes/references/step-7-validate.md](website-to-hyperframes/references/step-7-validate.md)
...
| File                                                    | When to read                                                                                                                                                   |
| ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [step-1-capture.md](website-to-hyperframes/references/step-1-capture.md)       | Step 1 — reading captured data                                                                                                                                 |
| [step-2-design.md](website-to-hyperframes/references/step-2-design.md)         | Step 2 — writing DESIGN.md                                                                                                                                     |
| [step-3-script.md](website-to-hyperframes/references/step-3-script.md)         | Step 3 — writing the narration script                                                                                                                          |
| [step-4-storyboard.md](website-to-hyperframes/references/step-4-storyboard.md) | Step 4 — per-beat creative direction                                                                                                                           |
| [step-5-vo.md](website-to-hyperframes/references/step-5-vo.md)                 | Step 5 — TTS, transcription, timing                                                                                                                            |
| [step-6-build.md](website-to-hyperframes/references/step-6-build.md)           | Step 6 — building compositions with self-review                                                                                                                |
| [step-7-validate.md](website-to-hyperframes/references/step-7-validate.md)     | Step 7 — lint, validate, preview, handoff                                                                                                                      |
| [techniques.md](website-to-hyperframes/references/techniques.md)               | Steps 4 & 6 — 10 visual techniques with code patterns (SVG drawing, Canvas 2D, 3D, typography, Lottie, video, typing, variable fonts, MotionPath, transitions) |

---
name: "animated-explainer-scene-plan-director"
description: "Produce scene_plan for the Animated Explainer pipeline."
...
Produce a schema-valid `scene_plan.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

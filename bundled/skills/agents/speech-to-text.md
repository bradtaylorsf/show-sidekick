...
> **Setup:** See [Installation Guide](speech-to-text/references/installation.md). For JavaScript, use `@elevenlabs/*` packages only.
...
- [Installation Guide](speech-to-text/references/installation.md)
- [Transcription Options](speech-to-text/references/transcription-options.md)
- [Real-Time Client-Side Streaming](speech-to-text/references/realtime-client-side.md)
- [Real-Time Server-Side Streaming](speech-to-text/references/realtime-server-side.md)
- [Commit Strategies](speech-to-text/references/realtime-commit-strategies.md)
- [Real-Time Event Reference](speech-to-text/references/realtime-events.md)

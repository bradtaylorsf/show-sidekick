---
name: "clip-factory-assets-director"
description: "Produce asset_manifest for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Clip Factory

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

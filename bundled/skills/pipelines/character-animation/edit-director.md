...
description: "Produce edit_decisions for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Character Animation

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.

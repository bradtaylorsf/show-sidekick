...
description: "Produce edit_decisions for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Clip Factory

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

---
name: "character-animation-research-director"
description: "Produce research_brief for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "research"
produces: "research_brief"
---
# Research Director - Character Animation

## Goal

Produce a schema-valid `research_brief.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.

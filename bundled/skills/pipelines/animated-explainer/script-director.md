...
description: "Produce script for the Animated Explainer pipeline."
...
Produce a schema-valid `script.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

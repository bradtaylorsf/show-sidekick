...
description: "Produce publish_log for the Talking Head pipeline."
applies_to: "pipelines/talking-head"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Talking Head

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `talking-head` pipeline and can be reviewed without private harness context.

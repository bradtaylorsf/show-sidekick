...
description: "Produce render_report for the Animated Explainer pipeline."
applies_to: "pipelines/animated-explainer"
stage: "compose"
produces: "render_report"
---
# Compose Director - Animated Explainer

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

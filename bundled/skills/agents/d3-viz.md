...
- `d3-d3-viz/patterns.md` - Comprehensive collection of visualisation patterns and code examples
- `scale-d3-viz/reference.md` - Complete guide to d3 scales with examples

...
description: "Orchestrate the Animation bundled pipeline."
applies_to: "pipelines/animation"
---
# Executive Producer - Animation

This is the demo readiness lane: animation. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

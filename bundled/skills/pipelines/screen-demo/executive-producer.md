...
description: "Orchestrate the Screen Demo bundled pipeline."
applies_to: "pipelines/screen-demo"
---
# Executive Producer - Screen Demo

This is the demo readiness lane: screen-demo. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

...
description: "Produce rig_plan for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "rig_plan"
produces: "rig_plan"
---
# Rig Plan Director - Character Animation

## Goal

Produce a schema-valid `rig_plan.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.
...
- The artifact matches `schemas/artifacts/rig_plan.schema.json`.

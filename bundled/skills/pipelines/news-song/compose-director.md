...
description: "Produce render_report for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "compose"
produces: "render_report"
---
# Compose Director - News Song

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

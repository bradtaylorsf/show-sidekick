---
name: "animated-explainer-assets-director"
description: "Produce asset_manifest for the Animated Explainer pipeline."
applies_to: "pipelines/animated-explainer"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Animated Explainer

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

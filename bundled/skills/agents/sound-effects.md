...
> **Setup:** See [Installation Guide](sound-effects/references/installation.md). For JavaScript, use `@elevenlabs/*` packages only.
...
- [Installation Guide](sound-effects/references/installation.md)

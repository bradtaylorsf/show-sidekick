...
|-------|----------|---------|
| Prior artifacts | `priorArtifacts.scene_plan`, `priorArtifacts.assets`, `priorArtifacts.script` | Locale treatments, localized assets, and timing notes |
| Playbook | Active style playbook | Subtitle and localization layout consistency |

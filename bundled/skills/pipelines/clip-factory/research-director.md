---
name: "clip-factory-research-director"
description: "Produce research_brief for the Clip Factory pipeline."
applies_to: "pipelines/clip-factory"
stage: "research"
produces: "research_brief"
---
# Research Director - Clip Factory

## Goal

Produce a schema-valid `research_brief.json` artifact that fits the `clip-factory` pipeline and can be reviewed without private harness context.

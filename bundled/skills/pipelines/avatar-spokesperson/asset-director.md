---
name: "avatar-spokesperson-assets-director"
description: "Produce asset_manifest for the Avatar Spokesperson pipeline."
applies_to: "pipelines/avatar-spokesperson"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Avatar Spokesperson

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `avatar-spokesperson` pipeline and can be reviewed without private harness context.

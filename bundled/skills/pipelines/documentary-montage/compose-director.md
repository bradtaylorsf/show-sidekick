...
description: "Produce render_report for the Documentary Montage pipeline."
applies_to: "pipelines/documentary-montage"
stage: "compose"
produces: "render_report"
---
# Compose Director - Documentary Montage

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `documentary-montage` pipeline and can be reviewed without private harness context.

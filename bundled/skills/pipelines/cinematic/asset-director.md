---
name: "cinematic-assets-director"
description: "Produce asset_manifest for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Cinematic

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

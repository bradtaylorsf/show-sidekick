...
description: "Produce publish_log for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Screen Demo

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

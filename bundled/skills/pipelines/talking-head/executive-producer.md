...
description: "Orchestrate the Talking Head bundled pipeline."
applies_to: "pipelines/talking-head"
---
# Executive Producer - Talking Head

This is the demo readiness lane: talking-head. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

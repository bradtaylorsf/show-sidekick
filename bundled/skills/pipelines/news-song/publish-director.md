---
name: "news-song-publish-director"
description: "Produce publish_log for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "publish"
produces: "publish_log"
---
# Publish Director - News Song

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

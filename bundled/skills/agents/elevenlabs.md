...
**Professional Voice Clone:** Requires Creator plan+, 30+ min audio. See [elevenlabs/reference.md](elevenlabs/reference.md).
...
python src/tools/voiceover.py --scene-dir public/audio/scenes --json
...
For full API docs, see [elevenlabs/reference.md](elevenlabs/reference.md).

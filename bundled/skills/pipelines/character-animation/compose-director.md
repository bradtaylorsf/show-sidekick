...
description: "Produce render_report for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "compose"
produces: "render_report"
---
# Compose Director - Character Animation

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.
...
- The artifact matches `schemas/artifacts/render_report.schema.json`.

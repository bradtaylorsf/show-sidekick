...
description: "Produce script for the News Song pipeline."
applies_to: "pipelines/news-song"
stage: "script"
produces: "script"
---
# Script Director - News Song

## Goal

Produce a schema-valid `script.json` artifact that fits the `news-song` pipeline and can be reviewed without private harness context.

...
description: "Produce edit_decisions for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "edit"
produces: "edit_decisions"
---
# Edit Director - Screen Demo

## Goal

Produce a schema-valid `edit_decisions.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

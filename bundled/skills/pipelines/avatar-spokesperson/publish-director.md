...
description: "Produce publish_log for the Avatar Spokesperson pipeline."
applies_to: "pipelines/avatar-spokesperson"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Avatar Spokesperson

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `avatar-spokesperson` pipeline and can be reviewed without private harness context.

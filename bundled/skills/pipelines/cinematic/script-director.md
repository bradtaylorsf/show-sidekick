...
description: "Produce script for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "script"
produces: "script"
---
# Script Director - Cinematic

## Goal

Produce a schema-valid `script.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

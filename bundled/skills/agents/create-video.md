...
Always use [prompt-optimizer.md](create-video/references/prompt-optimizer.md) guidelines to structure prompts with scenes, timing, and visual styles.

**With MCP tools:**
1. Write an optimized prompt using [prompt-optimizer.md](create-video/references/prompt-optimizer.md) → [create-video/visual-styles.md](create-video/references/visual-styles.md)
...
1. Write an optimized prompt using [prompt-optimizer.md](create-video/references/prompt-optimizer.md) → [create-video/visual-styles.md](create-video/references/visual-styles.md)
2. `POST /v1/video_agent/generate` — see [video-agent.md](create-video/references/video-agent.md)
3. `GET /v2/videos/<id>` — see [video-status.md](create-video/references/video-status.md)

## Quick Reference

| Task | MCP Tool | Read |
|------|----------|------|
| Generate video from prompt | `mcp__heygen__generate_video_agent` | [prompt-optimizer.md](create-video/references/prompt-optimizer.md) → [create-video/visual-styles.md](create-video/references/visual-styles.md) → [video-agent.md](create-video/references/video-agent.md) |
| Check video status / get download URL | `mcp__heygen__get_video` | [video-status.md](create-video/references/video-status.md) |
| Upload reference files for prompt | — | [assets.md](create-video/references/assets.md) |
...
### Core Workflow
- [create-video/references/prompt-optimizer.md](create-video/references/prompt-optimizer.md) - Writing effective prompts (core workflow + rules)
- [create-video/references/visual-styles.md](create-video/references/visual-styles.md) - 20 named visual styles with full specs
- [create-video/references/prompt-examples.md](create-video/references/prompt-examples.md) - Full production prompt example + ready-to-use templates
- [create-video/references/video-agent.md](create-video/references/video-agent.md) - Video Agent API endpoint details

### Foundation
- [create-video/references/video-status.md](create-video/references/video-status.md) - Polling patterns and download URLs
- [create-video/references/webhooks.md](create-video/references/webhooks.md) - Webhook endpoints and events
- [create-video/references/assets.md](create-video/references/assets.md) - Uploading images, videos, audio as references
- [create-video/references/dimensions.md](create-video/references/dimensions.md) - Resolution and aspect ratios
- [create-video/references/quota.md](create-video/references/quota.md) - Credit system and usage limits

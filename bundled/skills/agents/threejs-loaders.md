...
```javascript
// Set base path
loader.setPath("threejs-loaders/assets/models/");
loader.load("model.glb"); // Loads from threejs-loaders/assets/models/model.glb

// Set resource path (for textures referenced in model)
loader.setResourcePath("threejs-loaders/assets/textures/");

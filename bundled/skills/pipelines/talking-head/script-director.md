...
description: "Produce script for the Talking Head pipeline."
applies_to: "pipelines/talking-head"
stage: "script"
produces: "script"
---
# Script Director - Talking Head

## Goal

Produce a schema-valid `script.json` artifact that fits the `talking-head` pipeline and can be reviewed without private harness context.

...
description: "Produce source_media_review for the Podcast Repurpose pipeline."
applies_to: "pipelines/podcast-repurpose"
stage: "source_review"
produces: "source_media_review"
---
# Source Review Director - Podcast Repurpose

## Goal

Produce a schema-valid `source_media_review.json` artifact that fits the `podcast-repurpose` pipeline and can be reviewed without private harness context.
...
- The artifact matches `schemas/artifacts/source_media_review.schema.json`.

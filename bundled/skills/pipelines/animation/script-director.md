...
description: "Produce script for the Animation pipeline."
...
Produce a schema-valid `script.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

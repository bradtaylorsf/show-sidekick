---
name: "character-animation-assets-director"
description: "Produce asset_manifest for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "assets"
produces: "asset_manifest"
---
# Assets Director - Character Animation

## Goal

Produce a schema-valid `asset_manifest.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.

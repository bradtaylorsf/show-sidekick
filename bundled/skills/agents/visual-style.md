...
5. **Generate** — Output complete `visual-style.md` using [visual-style/references/templates/minimal.visual-style.md](visual-style/references/templates/minimal.visual-style.md) or [visual-style/references/templates/full.visual-style.md](visual-style/references/templates/full.visual-style.md)
...
1. **List styles** — Show available styles from [visual-style/references/gallery/](visual-style/references/gallery/)
...
Full spec: [visual-style/references/spec.md](visual-style/references/spec.md)
...
|-----------|----------|------|
| HeyGen Video Agent | AI video generation | [visual-style/references/connectors/heygen-video-agent.md](visual-style/references/connectors/heygen-video-agent.md) |
| HTML Slides | Web presentations | [visual-style/references/connectors/html-slides.md](visual-style/references/connectors/html-slides.md) |
| paper.design | Design documents | [visual-style/references/connectors/paper-design.md](visual-style/references/connectors/paper-design.md) |
| Figma | Design tool styles | [visual-style/references/connectors/figma.md](visual-style/references/connectors/figma.md) |

### Extractors (Extract mode)

| Source | File |
|--------|------|
| Website URL | [visual-style/references/extractors/from-website.md](visual-style/references/extractors/from-website.md) |
| Video keyframes | [visual-style/references/extractors/from-video.md](visual-style/references/extractors/from-video.md) |
| PDF / Brand guide | [visual-style/references/extractors/from-pdf.md](visual-style/references/extractors/from-pdf.md) |

### Gallery (pre-built styles)

| Style | Era | File |
|-------|-----|------|
| Müller-Brockmann Swiss | 1950s–70s | [visual-style/references/gallery/mueller-brockmann-swiss.visual-style.md](visual-style/references/gallery/mueller-brockmann-swiss.visual-style.md) |
| Neville Brody Industrial | Late 1980s–90s | [visual-style/references/gallery/neville-brody-industrial.visual-style.md](visual-style/references/gallery/neville-brody-industrial.visual-style.md) |
| Saul Bass Cinematic | 1950s–60s | [visual-style/references/gallery/saul-bass-cinematic.visual-style.md](visual-style/references/gallery/saul-bass-cinematic.visual-style.md) |
| Game Boy Color | 1998–2003 | [visual-style/references/gallery/game-boy-color.visual-style.md](visual-style/references/gallery/game-boy-color.visual-style.md) |
| HeyGen AI Video | 2020s | [visual-style/references/gallery/heygen-ai-video.visual-style.md](visual-style/references/gallery/heygen-ai-video.visual-style.md) |

### Templates & Spec

- [visual-style/references/templates/minimal.visual-style.md](visual-style/references/templates/minimal.visual-style.md) — Bare minimum template
- [visual-style/references/templates/full.visual-style.md](visual-style/references/templates/full.visual-style.md) — Complete template with all fields
- [visual-style/references/spec.md](visual-style/references/spec.md) — Full format specification

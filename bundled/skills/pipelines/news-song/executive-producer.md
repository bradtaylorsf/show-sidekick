...
description: "Orchestrate the News Song bundled pipeline."
applies_to: "pipelines/news-song"
---
# Executive Producer - News Song

This is the demo readiness lane: news-song. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

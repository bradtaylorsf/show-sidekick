...
description: "Produce publish_log for the Animated Explainer pipeline."
applies_to: "pipelines/animated-explainer"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Animated Explainer

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

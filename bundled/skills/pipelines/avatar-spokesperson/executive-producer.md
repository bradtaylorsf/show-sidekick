...
description: "Orchestrate the Avatar Spokesperson bundled pipeline."
applies_to: "pipelines/avatar-spokesperson"
---
# Executive Producer - Avatar Spokesperson

This is the demo readiness lane: avatar-spokesperson. Keep the workflow predit-native and resolve all skills from the user project's .predit cache or explicit project overrides.

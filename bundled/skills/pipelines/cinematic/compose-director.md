...
description: "Produce render_report for the Cinematic pipeline."
applies_to: "pipelines/cinematic"
stage: "compose"
produces: "render_report"
---
# Compose Director - Cinematic

## Goal

Produce a schema-valid `render_report.json` artifact that fits the `cinematic` pipeline and can be reviewed without private harness context.

---
name: "documentary-montage-scene-plan-director"
description: "Produce scene_plan for the Documentary Montage pipeline."
applies_to: "pipelines/documentary-montage"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Documentary Montage

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `documentary-montage` pipeline and can be reviewed without private harness context.

...
description: "Produce brief for the Animated Explainer pipeline."
applies_to: "pipelines/animated-explainer"
stage: "idea"
produces: "brief"
---
# Idea Director - Animated Explainer

## Goal

Produce a schema-valid `brief.json` artifact that fits the `animated-explainer` pipeline and can be reviewed without private harness context.

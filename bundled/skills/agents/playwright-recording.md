...
```typescript
// playwright-recording/scripts/record-demo.ts
...
Run with:
```bash
npx ts-node playwright-recording/scripts/record-demo.ts
# or
npx tsx playwright-recording/scripts/record-demo.ts
```
...
Just say "improve this skill" and I'll guide you through updating `.show-sidekick/skills/agents/playwright-recording.md`.

...
description: "Produce publish_log for the Animation pipeline."
applies_to: "pipelines/animation"
stage: "publish"
produces: "publish_log"
---
# Publish Director - Animation

## Goal

Produce a schema-valid `publish_log.json` artifact that fits the `animation` pipeline and can be reviewed without private harness context.

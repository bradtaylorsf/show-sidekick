...
description: "Produce brief for the Screen Demo pipeline."
applies_to: "pipelines/screen-demo"
stage: "idea"
produces: "brief"
---
# Idea Director - Screen Demo

## Goal

Produce a schema-valid `brief.json` artifact that fits the `screen-demo` pipeline and can be reviewed without private harness context.

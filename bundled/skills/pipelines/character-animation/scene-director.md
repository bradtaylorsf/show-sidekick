---
name: "character-animation-scene-plan-director"
description: "Produce scene_plan for the Character Animation pipeline."
applies_to: "pipelines/character-animation"
stage: "scene_plan"
produces: "scene_plan"
---
# Scene Plan Director - Character Animation

## Goal

Produce a schema-valid `scene_plan.json` artifact that fits the `character-animation` pipeline and can be reviewed without private harness context.
